...
import { RefreshCw, Activity, ShieldAlert, CheckCircle2, Target, Newspaper } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 py-6">
      ...
      {/* Main Dashboard */}
      {!loading && data && (
        <div className="grid grid-cols-1 md:col-span-2 lg:grid-cols-12 gap-4 animate-in fade-in zoom-in-95 duration-500">
